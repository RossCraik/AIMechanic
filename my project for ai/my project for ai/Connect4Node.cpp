...
void Connect4Node::setGameState(GameState newWorldState)
{
...
*/
void Connect4Node::generatePossibleMoves()
{
...
Connect4Node* Connect4Node::Expand()
{
	...
	else
	{
		...
		Connect4Node* childNode = new Connect4Node();
...
*/
void Connect4Node::Simulate(BOARD_SQUARE_STATE startingTurn)
{
...
void Connect4Node::CalcResult(BOARD_SQUARE_STATE winner)
{
...
void Connect4Node::Backpropagate(int result)
{
...
Connect4Node* Connect4Node::FindHighestRankingChild(bool report)
{
